    ...
    fun reportToMessageCollector(
        ...
        return reportByFile(diagnosticsCollector) { diagnostic, location ->
            ...
            AnalyzerWithCompilerReport.reportSpecialErrors(
                ...
                hasPrereleaseClasses = false,   // TODO: PRE_RELEASE_CLASS
                hasUnstableClasses = false,     // TODO: IR_WITH_UNSTABLE_ABI_COMPILED_CLASS
                hasFirUnstableClasses = false,  // TODO: FIR_COMPILED_CLASS
                messageCollector,
            )
        }
    }
