...
//            map.put(UNKNOWN_CALLABLE_KIND, ...) // &
        ...
        map.put(
            ...
            "Extension function type is prohibited on a function type without parameters or on a non-function type."
        )
        map.put(
            WRONG_EXTENSION_FUNCTION_TYPE_WARNING,
            "Extension function type makes no sense on a non-function type. It will be an error in a future release. See https://youtrack.jetbrains.com/issue/KT-43527."
        )
        map.put(
