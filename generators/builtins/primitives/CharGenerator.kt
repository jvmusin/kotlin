...
private fun ClassBuilder.generateHashCode(methodVisibility: MethodVisibility?) {
    method {
        signature {
...
class JsCharGenerator(writer: PrintWriter) : CharGenerator(writer) {
    override fun FileBuilder.modifyGeneratedFile() {
        appendDoc("Char is a magic class.")
        appendDoc("Char is defined as a regular class, but we lower it as a value class.")
        appendDoc("See [org.jetbrains.kotlin.ir.backend.js.utils.JsInlineClassesUtils.isClassInlineLike] for explanation.")
    }
