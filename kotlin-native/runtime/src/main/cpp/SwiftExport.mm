...
extern "C" ObjHeader *Kotlin_SwiftExport_swiftObjectToRef(id obj) {
    ObjHolder holder;
    return Kotlin_ObjCExport_refFromObjC(obj, holder.slot()); // FIXME: For now, we just unwrap objc counterparts
}
